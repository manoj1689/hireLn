 ...
 function CreateJobPage() {
  ...
  return (
    <MainLayout>
      ...
      <div className="flex max-lg:pt-20 items-center justify-between">
        <div>
   ...
   <div className="mt-6 w-full ">
      ...
      <div className="w-full xl:w-1/4 hidden  xl:block">
        <Card>
...
function StepIndicator({ number, title, isActive, isCompleted }: StepIndicatorProps) {
  return (
    <div className="flex flex-col items-center">
      ...
      <span className={`mt-2 text-xs font-medium ${isActive || isCompleted ? "text-primary" : "text-gray-500"}`}>
        {title}
      </span>
    </div>
  )
