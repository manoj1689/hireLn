    ...
    return (
        <>
                    ...
                    >
                        <section>
                            <section>
                                <span className="px-4 py-2 bg-[#FF993F] text-xs sm:text-md lg:text-lg rounded-full">
                                    Welcome to{" "}
                                    <span className="font-semibold">HireLane</span> – Your AI
                                    Hiring Assistant
                                </span>
                            </section>
                        ...
                        <section className="flex w-full mx-auto flex-col justify-start mt-8">
                            <section className="flex gap-5">
                                <button className="px-4 py-2 bg-white rounded-md text-md md:text-lg text-[#15B8A6] hover:shadow-lg transition-all">
                                    Start Free Trial
                                </button>
                                <button
                                    onClick={onOpenModal}
            ...
            <Modal
                ...
                showCloseIcon
                classNames={{
                    modal: "container rounded-2xl overflow-hidden p-0 bg-transparent shadow-lg",
                }}
                styles={{
                    modal: {
