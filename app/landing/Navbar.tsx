          ...
          <div className="hidden lg:flex lg:w-3/4 justify-end items-center lg:gap-4 xl:gap-6">
            ...
            <div className="flex flex-col items-center">
              <button
                ...
                className={`bg-white text-[#15B8A6] text-lg rounded-full shadow-lg px-4 py-1 hover:bg-gray-200 hover:scale-105   transition-all duration-300 ${
                  activeSection === "Signin" ? "font-medium" : ""
                }`}
              >
                Sign In
              </button>
