...
const ChecklistIcons = ({ permissions }) => {
  return (
    <div className="fixed bg-gray-200 left-4 top-1/2 -translate-y-1/2 flex  rounded-lg shadow-lg flex-col items-center gap-4 z-50">
      {/* Camera */}
      <div
